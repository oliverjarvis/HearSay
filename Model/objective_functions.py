...
def objective_function_veracity_branchLSTM(params):
    ...
    x_train_embeddings, x_train_metafeatures, y_train = load_data_from_dir("train", num_classes=3, data_dir=data_dir)
    x_test_embeddings, x_test_metafeatures, y_test, ids_test = load_data_from_dir("dev", num_classes=0, with_ids = True, data_dir=data_dir)
